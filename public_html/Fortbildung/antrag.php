...
$anfrage =
"select Vorname, Nachname, Lehrer.P_NR, Beantragt.P_NR, Angebot.A_Name, Beantragt.A_NR, Angebot.ID_AN, Bezeichnung, vom, bis
from
Lehrer, Angebot, Beantragt 
where
Lehrer.P_NR = Beantragt.P_NR
and
Beantragt.A_NR = Angebot.ID_AN
order by Angebot.ID_AN, Nachname
";
//, Besucht, Angebot
//where
